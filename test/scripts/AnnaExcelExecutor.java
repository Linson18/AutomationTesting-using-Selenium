...
//file to execute
public class AnnaExcelExecutor {
	WebDriver driver;
	Sheet excelSheet;
...
public void testLogin() throws Exception {
        ...
        //Read keyword sheet
        excelSheet = ReadExcelFileSheet.getExcelSheet("test\\resources\\data\\","AnnaUniversity.xlsx" , "Frameworksheet");//calls ReadExcelFileSheet.class file
